package com.mashiibing.jvm.orm.zero;

import com.mashiibing.jvm.orm.first.UserEntity;
...
public class App000 {
    ...
    private void start() throws Exception {
        ...
        // 数据库连接地址
        String dbConnStr = "jdbc:mysql://127.0.0.1:3306/ormtest?user=root&password=";
        // 创建数据库连接
